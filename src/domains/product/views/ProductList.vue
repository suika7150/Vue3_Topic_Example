      ...
      <div class="product-list-header">
        <div class="header-controls">
          <div class="toolbar-wrapper">
            <ProductFilterToolbar v-model="filters" :categories="categories" />
          </div>
        </div>
      </div>
...
import ProductFilterToolbar from '@/domains/product/components/ProductFilterToolbar.vue'
import api from '@/services/api'
import { useNavigation } from '@/composables/useNavigation'
import { useProductFilter } from '@/domains/product/composables/useProductFilter'
import { useProductPagination } from '@/domains/product/composables/useProductPagination'
import { useProductSearch } from '@/domains/product/composables/useProductSearch'
import { useCartStore } from '@/stores/cartStore'
import Storage, { CART_KEY } from '@/utils/storageUtil'
import { logger } from '@/utils/loggerUtil'
import { DEFAULT_PRODUCT_IMAGE } from '@/domains/product/constants/productConstants'
