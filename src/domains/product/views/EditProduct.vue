<template>
  ...
  <AppImageCropper ref="cropperRef" @on-crop="handleCropped" />
</template>
...
} from '@/domains/product/constants/productConstants'
import { useProductForm } from '@/domains/product/composables/useProductForm'
